...
<h1>● Open Interpreter<br/><sup> GALAXY-AI Plugin</sup></h1>
...
This is a function calling plugin for [RoyelSteven-Ai](https://github.com/RoyelSteven-Ai/GALAXY), you can install it in plugin setting page.
...
```bash
$ git clone https://github.com/RoyelSteven-Ai/GALAXY/tree/Chat-Plugin-Open-Interpreter.git
...
Copyright © 2024 [GALAXY-AI][profile-url]. <br />
